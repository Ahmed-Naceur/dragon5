...
*----
   ...
   40 CONTINUE
     ...
     1 NREG,NUN,IPHASE,LEXAC,MAT,VOL,KEYFLX,TITR,SUN,FUN1)
...
*
   ...
   60 CONTINUE
      ...
      ENDIF
      CALL DOORFV (CDOOR,JPSYS,NPSYS,IPTRK,IFTRAK,IMPX,NGRO,NBM,
     1 IDIR,NREG,NUN,IPHASE,LEXAC,MAT,VOL,KEYFLX,TITR,SUN,FUN2)
