...
*  LOCAL VARIABLES
*----
      TYPE(C_PTR) JPMAC,KPMAC,DCUTOFF_PTR
...
*  ALLOCATABLE ARRAYS
*----
      REAL, POINTER, DIMENSION(:) :: DCUTOFF
...
* UNDER CUTOFF ENERGY RECUPERATION
...
* UNDER CUTOFF ENERGY CORRECTION
            EDEPO(IBM,I)=EDEPO(IBM,I)+DCUTOFF(IBM)*ZNORM
