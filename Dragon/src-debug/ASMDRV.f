...
*         INCLUDE RESTRICTED STOPPING POWER.
          ...
          DEALLOCATE(TEMP)
*         INCLUDE RESTRICTED MOMENTUM TRANSFERT
          CALL LCMLEN(KPMACR,'EMOMTR',IMOMTR,ITYLCM)
          IF(IMOMTR.GT.0) THEN
          ALLOCATE(TEMP(2*NBMIX))
          ...
          DO I1=1,NBMIX
          DO I2=1,IGR
          IF(EMOMTR(I1,I2).GT.10E-20) THEN
             ISMOMTR=.TRUE.
             GO TO 56
          ENDIF
          ENDDO
...
*----
      ...
      IF(IBFP.GT.0) THEN
        ...
        CALL LCMPUT(KPSYS,'DRAGON-ECUTOFF',1,2,ENERGY(IGR+1)/1.0E6)
        ENDIF
        IF(ISMOMTR) THEN
        CALL LCMPUT(KPSYS,'DRAGON-EMOMTR',(NBMIX+1),2,EMOMTR(0,IGR))
        ENDIF
      ENDIF
