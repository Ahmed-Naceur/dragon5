*DECK MOCSCA
      SUBROUTINE MOCSCA(N,NREG,NSOUT,M,NOM,NZON,H,SIGANG,EXPT,EXP2,
     1           NMU,ZMU)
*
*-----------------------------------------------------------------------
*
...
* and 'source term isolation' option turned on.
*
*Copyright:
...
*----
      ...
      REAL TAU
      DOUBLE PRECISION HID,TAUD,TEMP
...
*              Out of the table range
                  EXPT(IMU,I)=0.D0
                  EXP2(IMU,I)=1.D0/DBLE(SIGANG(NZI))
               ELSE
