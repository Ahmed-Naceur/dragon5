*DECK SNFT1P
     ...
     1 TOTAL,NCODE,ZCODE,QEXT,LFIXUP,FLUX,ISBS,NBS,ISBSM,BS)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*----
      INTEGER NREG,NMAT,ISCHM,IELEM,NLF,NSCT,MAT(NREG),NCODE(2),ISBS,
     1 NBS,ISBSM(2*ISBS,NLF*ISBS)
      REAL U(NLF),W(NLF),PL(NSCT,NLF),VOL(NREG),TOTAL(0:NMAT),ZCODE(2),
     1 QEXT(IELEM,NSCT,NREG),FLUX(IELEM,NSCT,NREG),BS(NBS*ISBS)
      LOGICAL LFIXUP
*----
*  LOCAL VARIABLES
*----
