...
*----
      IDIR=0
      LEXAC=.FALSE.
      CALL DOORFV(CDOOR,JPSYS2,NPSYS,IPTRK2,IFTRAK,IPRIN2,NGCOND,NBMIX2,
     1 IDIR,NREG2,NUN2,IPHASE,LEXAC,MAT2,VOL2,KEY2,CTITRE,SUNKNO,FUNKNO)
*----
