*DECK SNFLUX
     ...
     1 NBMIX,NUN,MAT,VOL,KEYFLX,FUNKNO,SUNKNO,ITER,FLUXC)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*
  ...
  250   CONTINUE
     ...
     2    LFIXUP,DU,DE,W,MRM,MRMY,DB,DA,PL,FUNKNO,FLUXC)
     ...
     2    QEXT,DU,DE,W,MRM,MRMY,DB,DA,PL,FUNKNO,FLUXC)
        ELSE
...
*
  ...
  390   CONTINUE
     ...
     1    NBMIX,NPQ,NSCT,MAT,VOL,SGAR,ESTOPW,NCODE,ZCODE,DELTAE,QEXT,
     2    LFIXUP,DU,DE,DZ,W,MRMX,MRMY,MRMZ,DC,DB,DA,PL,FUNKNO,FLUXC)
        ELSE IF((ISCHM.EQ.2).AND.(IOMP.EQ.0)) THEN
          CALL SNFP23(NUN,NGEFF,IMPX,INCONV,NGIND,LX,LY,LZ,IELEM,IBFP,
     1    NBMIX,NPQ,NSCT,MAT,VOL,SGAR,ESTOPW,NCODE,ZCODE,DELTAE,QEXT,
     2    DU,DE,DZ,W,MRMX,MRMY,MRMZ,DC,DB,DA,PL,FUNKNO,FLUXC)
        ELSE
          CALL XABORT('SNFLUX: TECHNIQUE NOT IMPLEMENTED.')
        ENDIF
        DO 395 IR=1,NREG
