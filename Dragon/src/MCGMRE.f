...
*----
     ...
     4 N2SOU,NZP,IDIR
      REAL QFR(NUN,NGROUP),PHIIN(NUN,NGROUP),CPO(NMU),ZMU(NMU),
...
*---
     ...
     5       LPS,NCONV,.FALSE.,.FALSE.,STIS,NPJJM,REBFLG,LPRISM,N2REG,
...
*---
        DO II=1,NGEFF
          ...
          ENDDO
          DO J=1,K
            PHIIN(:,IG)=PHIIN(:,IG)+REAL(G(J,II)*V(:,II,J))
          ENDDO
        ENDDO
      ENDDO
*----
