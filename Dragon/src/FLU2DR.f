...
*----
  ...
  150 CONTINUE
     ...
     2   FLUX(1,1,8),FLUX(1,1,7),IPREB,REBFLG,FLUXC)
     ...
     2   ILEAK,B2,DIFF,GAMMA,FLUX(1,1,6),IPREB,REBFLG,FLUXC)
      ELSE
...
*
     ...
     2     TITLE,ILEAK,B2,DIFF,GAMMA,FLUX(1,1,6),IPREB,REBFLG,FLUXC)
         ENDIF
  230    CONTINUE
      ENDIF
