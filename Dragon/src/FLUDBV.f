*DECK FLUDBV
     ...
     2 ILEAK,B2,DDD,GAMMA,FLUX,IPMACR,REBFLG,FLUXC)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*
   ...
   30    CONTINUE
     ...
     2        TITLE,FLUX(1,1,3),FLUX(1,1,2),IPMACR,REBFLG,FLUXC)
...
*        ISOTROPIC STREAMING MODEL (ECCO).
  ...
  145    CONTINUE
         IDIR=0
         CALL DOORFV(CDOOR,JPSTR,NPSYS,IPTRK,IFTRAK,IPRT,NGRP,
     1        NMAT,IDIR,NREG,NUNKNO/2,IPHASE,LEXAC,MATCOD,VOL,KEYFLX,
     2        TITLE,SUNKNO,FUNKNO,IPMACR,REBFLG,FLUXC)
         IOF=0
         DO 155 IGR=1,NGRP
