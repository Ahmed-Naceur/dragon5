*DECK FLUDBV
     ...
     2 ILEAK,B2,DDD,GAMMA,FLUX,IPMACR,REBFLG,IPSOUR)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*----
      ...
      TYPE(C_PTR) JPSYS,JPSTR,IPTRK,IPMACR,IPSOUR
...
*
   ...
   30    CONTINUE
     ...
     2        TITLE,FLUX(1,1,3),FLUX(1,1,2),IPMACR,REBFLG,DCUTOFF,
     3        IPSOUR)
...
*        ISOTROPIC STREAMING MODEL (ECCO).
  ...
  145    CONTINUE
     ...
     2        TITLE,SUNKNO,FUNKNO,IPMACR,REBFLG,DCUTOFF,IPSOUR)
         IOF=0
         DO 155 IGR=1,NGRP
...
*        ----
 ...
 250     CONTINUE
     ...
     3        IPMACR,REBFLG,DCUTOFF,IPSOUR)
 260     CONTINUE
      ELSE
