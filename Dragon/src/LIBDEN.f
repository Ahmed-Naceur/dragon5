...
*----      
     ...
     1  DENMAT)  
        ...
        IF (STERN.EQ.1) THEN 
          PRINT *,"STERNHEIMER CORRECTION APPLYED TO THE H-FACTOR"
        ELSE
            PRINT *,"STERNHEIMER CORRECTION NOT APPLYED TO THE H-FACTOR"
        ENDIF
      ENDIF
*----
...
*----
      ...
      IF(MASK(IBM).OR.(.NOT.MASKK)) THEN
         DO 255 IP=1,14 !AHMED: CORRECT TO INCLUDE C-FACTOR
         DO 250 LLL=1,NGROUP
         GAF(IBM,LLL,IP)=0.0
  250    CONTINUE
  255    CONTINUE
...
*-
  ...
  280          CONTINUE
         ...
         IF(ILONG.GT.0) THEN
            ...
            !POSITRON. REASON: SOFT INLEASTIC HEAT DEPOSITION IN ELECTR
            !CONTAINS A COLLISONNAL DENSITY CORRECTION WHICH HAS NOT
            !BEEN CORRECTED IN NJOY (SEE NJOY MANUAL, EQ.433)
            IF (STERN.EQ.1) THEN 
               IF (HPRT1.EQ.'B'.OR.HPRT1.EQ.'C') THEN 
