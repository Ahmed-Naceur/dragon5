...
*     ORDER TO REDUCE CPU TIME)
      ...
      CALL LCMGET(JPLIB,'SCAT'//CM//NORD(IXSPER),GA2) !AHMED:REACHED
      IOF0=0
      DO 90 LLL=1,LLL0
      IOF0=IOF0+NJJ(LLL)
   90 CONTINUE
...
*----
      ...
      IF(MASK(IBM).OR.(.NOT.MASKK)) THEN
         DO 255 IP=1,14 !AHMED: modified for C-FACTOR calculations
         DO 250 LLL=1,NGROUP
         GAF(IBM,LLL,IP)=0.0
  250    CONTINUE
  255    CONTINUE
...
*-
  ...
  290       CONTINUE
         ...
         IF(ILONG.GT.0) THEN
            ...
            !AHMED-DEBUG
            !PRINT *,"------------------------LLL",LLL
            !PRINT *,"GAF-i=",GAF(IBM,LLL,13)
            !PRINT *,"GA1=",GA1(LLL)
            !PRINT *,"DENISO=",DENISO
            GAF(IBM,LLL,13)=GAF(IBM,LLL,13)+GA1(LLL)*DENISO !e/cm
            !PRINT *,"C-FACTOR2=",GAF(IBM,LLL,13)
  295       CONTINUE
         ENDIF
