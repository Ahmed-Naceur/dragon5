...
*
*Purpose:
* Compute the index table relation subgeometries
* to a complete geometry.
*
*Copyright:
...
*
*Parameters: input
* IHEX    type of symetry:
*         =1 : s30   =2 : sa60   =3 : sb60   =4 : s90   =5 : r120
*         =6 : r180  =7 : sa180  =8 : sb180  =9 : complete.
* NH      total number of hexagons in each subgeometry.
*
*Parameters: output
* NTH     total number of hexagons in unfolded geometry.
* ITAB    Association table for subgeometry in unfolded geometry.
*
*-----------------------------------------------------------------------
*
      LOGICAL LPAIR
