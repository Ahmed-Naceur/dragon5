*DECK SNF
      SUBROUTINE SNF (IPSYS,NPSYS,IPTRK,IPSOUR,IFTRAK,IMPX,NGRP,IDIR,
     1 NREG,NBMIX,NUN,MAT,VOL,KEYFLX,FUNKNO,SUNKNO,TITR,DCUTOFF)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*----
         CALL SNGMRE (KPSYS,INGIND,IPTRK,IPSOUR,IMPX,NGRP,NGEFF,NREG
...
*----
     ...
     1   NREG,NBMIX,NUN,MAT,VOL,KEYFLX,FUNKNO,SUNKNO,ITER,DCUTOFF)
*----
