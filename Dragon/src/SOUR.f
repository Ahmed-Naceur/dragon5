...
! MONODIRECTIONAL SOURCE DIRCTION (2 ANGLES)
      ELSE IF(TEXT12.EQ.'DIR') THEN
        ...
        IF(INDIC.EQ.2) THEN
          ...
          ETA=TEMP2
          XI=FLOTT
          IF(MU.GT.1.0.OR.MU.LT.0.0.OR.ETA.GT.1.0.OR.ETA.LT.0.0.OR.
     1    XI.GT.1.0.OR.XI.LT.0.0) CALL XABORT('SOUR: INVALID DIRECTION'
     2    //' COSINES VALUES.')
        ELSE
          PANGLE=TEMP1
          AANGLE=TEMP2
          IF(PANGLE.GT.180.0.OR.PANGLE.LT.0.0.OR.AANGLE.GT.90.0.OR.
     1    AANGLE.LT.0.0) CALL XABORT('SOUR: INVALID POLAR OR AZIMUTAL'
     2    //' ANGLE.')
          GO TO 11
        ENDIF
! END OF INPUT DATA
...
! OTHER VERIFICATIONS
     ...
     1 //' POSITION NOT DEFINED.')
      IF(ISDIRDEF.EQ.0) CALL XABORT('SOUR: MONODIRECTIONAL SOURCE'
     1 //'DIRECTION NOT DEFINED.')
