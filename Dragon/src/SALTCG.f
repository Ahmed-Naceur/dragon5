...
*----
     ...
     >                 MAXREG,NBTCLS,MAXMSP,MAXRSP,NFSUR,
     >                 NFREG,MXGSUR,NUNK,NPLANE,NPOINT,
     >                 NTLINE,NBTDIR,MAXSUB,MAXSGL,NBDR
      ...
      INTEGER          IFMT,NEREG,NESUR,NUNKC
*----
*  Allocatable arrays
*----
      INTEGER, ALLOCATABLE, DIMENSION(:) :: NBSANG,KEYMRG,MATALB
...
*----
      ALLOCATE(KEYMRG(NUNK),MATALB(NUNK),SURVOL(NUNK))
