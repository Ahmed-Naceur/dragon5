...
*----
      ...
      IF(ITY.EQ.13) THEN
         CALL MTLDLM(TEXT12,IPTRK,IPSYS,LL4,ITY,ADECT(1,JGR),GAF1)
         DO 10 I=1,LL4
...
*
  210    N=N+1
         IF(N.GT.10) THEN
            IF(IMPX.GT.0) WRITE(6,'(/30H FLDADJ: FAILURE OF THE NEWTON,
...
*        SOLUTION OF A LINEAR SYSTEM.
         ...
         IF(IER.NE.0) CALL XABORT('FLDADJ: SINGULAR MATRIX.')
         ALP=ALP-D2F(1,3)
         BET=BET-D2F(2,3)
