...
*----
      CALL NSSDFC(IMPX,LUMP,LNEM,LX,LY,LZ,NCODE,ICODE,ZCODE,MAT,XXX,
     1 YYY,ZZZ,LL4F,LL4X,LL4Y,LL4Z,VOL,XX,YY,ZZ,IDL,KN,QFR,IQFR)
      IF(LUMP) THEN
      ...
      IF(LNEM) THEN
        ISTATE(12)=5 ! Nodal expansion method
      ELSE
        ISTATE(12)=4 ! Coarse mesh finite difference method
      ENDIF
      ISTATE(14)=LX
     ...
     1   ISTATE(14:16),ISTATE(25),ISTATE(27:29),ISTATE(38),ISTATE(39)
      ENDIF
*----
...
*
  ...
  110 FORMAT(/14H STATE VECTOR:/
     ...
     5 7H ICHX  ,I8,34H   (TYPE OF SOLUTION 4/5:CMFD/NEM)/
     6 7H LX    ,I8,40H   (NUMBER OF ELEMENTS ALONG THE X AXIS)/
     7 7H LY    ,I8,40H   (NUMBER OF ELEMENTS ALONG THE Y AXIS)/
     8 7H LZ    ,I8,40H   (NUMBER OF ELEMENTS ALONG THE Z AXIS)/
     ...
     4 7H LUMP  ,I8,35H   (UNKNOWN LUMP OPTION 0/1:OFF/ON)/
