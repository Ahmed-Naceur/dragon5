...
*----
      CALL NSSDFC(IMPX,LX,LY,LZ,NCODE,ICODE,ZCODE,MAT,XXX,YYY,ZZZ,LL4F,
     1 LL4X,LL4Y,LL4Z,VOL,XX,YY,ZZ,IDL,KN,QFR,IQFR)
      IF(IDIM.EQ.1) THEN
        NUN=LL4F*3+LL4X
      ELSE IF(IDIM.EQ.2) THEN
     ...
     1   ISTATE(14:16),ISTATE(25),ISTATE(27:29),ISTATE(39)
      ENDIF
*----
