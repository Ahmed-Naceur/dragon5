...
*----
     ...
     1 //'ED.')
      ...
      IF(ISTATE(12).EQ.4) THEN
        LNEM=.FALSE.
      ELSE IF(ISTATE(12).EQ.5) THEN
        LNEM=.TRUE.
      ELSE
        CALL XABORT('NSSF: CMFD OR NEM DISCRETIZATION EXPECTED.')
      ENDIF
...
*---
  ...
  100 IF(IGMAX.GT.NG) CALL XABORT('NSSF: IGMAX>NG.')
      ...
      CALL NSSDRV(IPTRK,IPMAC,IPFLX,LNEM,NUN,NG,LX1,NMIX,ITRIAL,EPSOUT,
