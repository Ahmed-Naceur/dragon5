...
*----
      ...
      ENDIF
      CALL LCMLEN(IPFLUX,'EDEP-CUTOFF',ILEN,ITYLCM)
      IF(ILEN.GT.0) THEN
         CALL LCMGET(IPFLUX,'EDEP-CUTOFF',DCUTOFF)
         CALL LCMPUT(IPMAC2,'EDEP-CUTOFF',ILEN,2,DCUTOFF)
      ENDIF
      CALL LCMLEN(IPFLUX,'NORM',ILEN,ITYLCM)
      IF(ILEN.GT.0) THEN
         CALL LCMGET(IPFLUX,'NORM',NORM)
         CALL LCMPUT(IPMAC2,'NORM',ILEN,2,NORM)
      ENDIF
*
